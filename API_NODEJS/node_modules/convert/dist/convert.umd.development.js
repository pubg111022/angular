(function (global, factory) {
	...
	(global = global || self, factory(global.convert = {}));
	...
	function _convert(quantity) {
	  return {
	    from: function from(_from) {
	      {
	        !(_from in allUnits) ?  invariant(false, _from + " is not a valid unit")  : void 0;
	      }
	      ...
	      return {
	        to: function to(_to) {
	          ...
	          {
	            !(_to in allUnits) ?  invariant(false, _to + " is not a valid unit")  : void 0;
	          ...
	          /* Family */
	          ]) ?  invariant(false, "No conversion could be found from " + _from + " to " + _to)  : void 0;
...

	            {
	              try {
	                ...
	                /* Difference */
	                  ...
	                  invariant(false, "Conversion for " + _from + " to " + _to + " can't be expressed as an integer")  ;
	              }
	            }
	...
	function convertMany(value) {
	  ...
	  !search ?  invariant(false, "value did not match expression " + splitExpression)  : void 0;
	  return {
	    /**
...
//# sourceMappingURL=convert.umd.development.js.map
